/*
 * @Author: tonyTang 
 * @Date: 2018-12-12 19:27:40 
 * @Last Modified by: tonyTang
 * @Last Modified time: 2018-12-14 17:52:35
 */

<template>
  <div id="legal-declration">
       <div class="legal-declration-container">
            <div class="legal-declration-header">
                <OtherHeader></OtherHeader>
            </div>
            <div class="legal-declration-main">
                <div class="legal-declration-banner">
                    <div class="first-title">法律声明</div>
                </div>
                <div class="legal-nav-container">
                    <div class="legal-nav-item" :class="[selectedIndex == 1 ? 'nav-item-active': '']" @click="selectItem(1)">用户协议</div>
                    <div class="legal-nav-item" :class="[selectedIndex == 2 ? 'nav-item-active': '']" @click="selectItem(2)">隐私条款</div>
                    <div class="legal-nav-item" :class="[selectedIndex == 3 ? 'nav-item-active': '']" @click="selectItem(3)">法律申明</div>
                </div>
                <div class="legal-item-content" id="tab1" v-show="selectedIndex == 1">
                    <ul v-on:scroll.stop.prevent="onScroll">
                        <li class="text-content">
                            <p class="text-content-paragraph indentation-text2"> 香港虎符科技公司（以下称 “公司”）是一家根据中华人民共和国香港特别行政区（以下简称“香港地区”）相关法律在香港注册成立的公司，该公司运营网站https://www.hoo.com（以下称“本网站”或“网站”），是一个专门供用户提供区块链资产管理服务的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。本网站所有内容，为便利用户，可能提供多个语言版本，若有冲突或遗漏等情况，以中文内容为准。</p>
                            <p class="text-content-paragraph paragraph-margin text-fontsize24">
                                重要提示：
                            </p>  
                            <p class="text-content-paragraph paragraph-margin"> 
                                我们在此特别提醒您：
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                            ...
                            <p class="text-content-paragraph paragraph-margin"> 
                                4 如果公司根据其单方判断认为您违反了本协议，或者根据您所在管辖区域的法律本网站提供的服务或者您使用本网站提供的服务的行为是非法的，公司有权随时暂停或终止您的账户，或者暂停或终止您使用本网站提供的服务。数字资产交易有极高风险，并不适合绝大部分人士。您了解和理解此投资有可能导致部分损失或全部损失，所以您应该以能承受的损失程度来决定投资的金额。您了解和理解数字资产会产生衍生风险，所以如有任何疑问，建议先寻求理财顾问的协助。此外，除了上述提及过的风险以外，还会有未能预测的风险存在。您应慎重考虑并用清晰的判断能力去评估自己的财政状况及上述各项风险而作出任何买卖数字资产的决定，并承担由此产生的全部损失，我们对此不承担任何责任。 
                            </p>   
                            <p class="text-content-paragraph paragraph-margin text-fontsize24">
                                敬告您：
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                                1. 您了解本网站仅为您提供交易、理财、借贷等一站式服务。本网站不参与您的任何交易，故您应自行谨慎判断确定相关数字资产及/或信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                            ...
                            <p class="text-content-paragraph paragraph-margin"> 
                                5. https://www.hoo.com为本网站唯一官方对外信息公布平台；
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                                6. 本网站任何服务均不接受信用卡支付；
                            </p>
                            ...
                            <p class="text-content-paragraph paragraph-margin">
                                1.1 《用户协议》（以下称“本协议”或“本条款及条件”），由正文、《隐私条款》、以及本网站已经发布的或将来可能发布的各类规则、声明、说明等构成。
                            </p>
                            <p class="text-content-paragraph paragraph-margin">
                            ...
                            <p class="text-content-paragraph paragraph-margin">
                                1.5 只有成为本网站的会员才可使用本网站提供的服务及享受其他本网站规定的只有会员才可获得的服务；会员外的其他您只有登陆网站、浏览网站及其他本网站规定的可获得的服务。
                            </p>
                            <p class="text-content-paragraph paragraph-margin">
                                1.6 通过注册和使用任何由本网站提供的服务和功能，您将被视为已阅读，理解并：
                            </p>
                            <p class="text-content-paragraph paragraph-margin indentation-text2">
                                1.6.1 接受本协议所有条款及条件的约束。
                            </p>
                            <p class="text-content-paragraph paragraph-margin" style="padding-left: .38rem;">
                                1.6.2 您确认您已年满16周岁或根据不同的可适用的法律规定的具有可订立合同的法定年龄，您在本网站的注册、销售或购买、发布信息等接受本网站服务的行为应当符合对您有管辖权的主权国家或地区相关法律法规，并有充分的能力接受这些条款，并订立交易，使用本网站进行数字的相关服务。
                            </p>
                            <p class="text-content-paragraph paragraph-margin indentation-text2">
                            ...
                            <p class="text-content-paragraph paragraph-margin indentation-text2" style="padding-left: .38rem;"> 
                                交易产品规则 您承诺在其进入本网站交易，通过本网站与其他用户进行交易的过程中良好遵守如下交易规则：                             
                            </p>
                            <p class="text-content-paragraph paragraph-margin" style="padding-left: .38rem;"> 
                                4.3.1浏览交易信息                             
                            </p>
                            ...
                            <p class="text-content-paragraph paragraph-margin" style="padding-left: .8rem;"> 
                                11.2.1.1 向您提供本网站服务；                            
                            </p>
                            <p class="text-content-paragraph paragraph-margin" style="padding-left: .8rem;"> 
                            ...
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                十三、出口控制您理解并承认，根据香港地区相关法律，您不得将本网站上的任何材料（包括软件）出口、再出口、进口或转移，故您保证不会主动实施或协助或参与任何上述违反法规的出口或有关转移或其他违反适用的法律和法规的行为；如发现此类情形，会向我们积极报告并协助我们处理。                         
                            </p>
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                            ...
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                十九、适用法律本协议全部内容均为根据香港地区法律订立的合同，其成立、解释、内容及执行均适用香港地区相关法律规定；任何因或与本协议约定的服务有关而产生的索赔或诉讼，都应依照香港地区的法律进行管辖并加以解释和执行。为避免疑义，这一条款明确适用于任何针对我们的侵权索赔。任何针对我们或者是和我们有关的索赔或诉讼的管辖法院或诉讼地均在香港地区。您无条件地获得在香港地区法院进行诉讼和上诉的排他性的管辖权。您也无条件地同意与本协议款有关的争议或问题或产生的任何索赔请求和诉讼的发生地或法院均排他性得在香港地区，如有本网站其他业务对管辖有专门约定从其约定。不方便法院的原则不适用于根据本服务条款的选择的法院。                          
                            </p>
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                二十、协议的生效和解释                          
                            </p>
                ...
                <div class="legal-item-content" id="tab2" v-show="selectedIndex == 2">
                   <ul v-on:scroll.stop.prevent="onScroll">
                        <li class="text-content">
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                一、双方                          
                            ...
                            <p class="text-content-paragraph paragraph-margin"> 
                                1.1 香港虎符科技公司（以下称 “公司”）是一家根据香港特别行政区相关法律在香港地区注册成立的公司，该公司运营网站https://www.hoo.com（以下称“本网站”或“网站”），该网站是一个专门供用户区块链资产管理服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。                          
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                            ...
                            <p class="text-content-paragraph paragraph-margin"> 
                                9.1 如果您有任何要求和意见，您可以通过电子邮件support@hoo.com，这是属于我们与您沟通的唯一有效和官方电子邮件，所以我们对您未使用有效的联系方式，任何作为或不作为不承担责任。                      
                            </p>
                            <p class="text-content-paragraph paragraph-margin"> 
                ...
                <div class="legal-item-content" id="tab3" v-show="selectedIndex == 3">
                    <ul v-on:scroll.stop.prevent="onScroll">
                        <li class="text-content">
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                第一条                          
                            ...
                            <p class="text-content-paragraph paragraph-margin indentation-text2"> 
                                本网站的宗旨是在不违反香港地区相关法律法规的前提下，尽可能地为全球广大数字资产爱好者及投资者提供专业的国际化水准的区块链资产管理服务平台。禁止使用本网站从事洗钱、走私、商业贿赂等一切非法交易活动，若发现此类事件，本站将冻结账户，立即报送有权机关。                  
                            </p>
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                第二条                          
                            </p>
                            ...
                            <p class="text-content-paragraph paragraph-margin indentation-text2"> 
                                本网站使用者因为违反本声明的规定而触犯香港地区相关法律的，本站作为服务的提供方，有义务对平台的规则及服务进行完善，但本网站并无触犯香港地区相关法律的动机和事实，对使用者的行为不承担任何连带作用。                  
                            </p>
                            <p class="text-content-paragraph paragraph-margin text-fontsize24"> 
                                第四条                          
                            </p>
                            ...
                            <p class="text-content-paragraph paragraph-margin indentation-text2"> 
                                本声明未涉及的问题参考香港地区的有关法律法规，当本声明与香港地区相关法律法规冲突时，以香港地区相关法律法规为准。                   
                            </p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="legal-declration-footer">
                <Footer2></Footer2>
            </div>
       </div>
  </div>
...
.legal-declration-main {
    background-color: rgba(247,247,247,1);;
    color: #333;
    text-align: center;
    width: 100%; 
} 
.legal-declration-banner{
    height: 5rem;
    width: 100%;
    background: url("../assets/image/legal/legal.png") no-repeat;
...
.nav-item-active{
    border-bottom: .03rem solid rgba(82,195,174,1);
}
.legal-item-content{
    height: 10rem;
    width: 11.2rem;
...
.legal-item-content>ul{
    overflow-y: scroll;
    height: 100%;
}
.legal-item-content>ul::-webkit-scrollbar{
    display: none;
}
.legal-declration-footer{
    height: 4rem;
    width: 100%;
    padding-top: .6rem;
